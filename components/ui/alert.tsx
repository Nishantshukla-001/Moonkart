...
function AlertTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 line-clamp-1 min-h-4 font-heading text-sm font-semibold tracking-tight",
        className
      )}
      {...props}
    />
...
function AlertDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 grid justify-items-start gap-1 text-sm leading-[160%] [&_p]:leading-relaxed",
        className
      )}
      {...props}
    />
