...
import { ProductVariantSection } from "@/features/products/components/ProductVariantSection";
    ...
    <Container className="flex flex-col gap-10 py-8 sm:py-10">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        <ProductVariantSection
          ...
          header={
            <>
              <div key="info" className="flex flex-col gap-2">
                {product.brand && (
                  <Link
              ...
              <div key="price" className="flex flex-wrap items-center gap-3">
              ...
              {product.shortDescription && (
                <p key="description" className="text-base leading-[160%] text-text-secondary">
                  {product.shortDescription}
                </p>
              )}
            </>
          ...
          details={
            <dl key="details" className="grid grid-cols-2 gap-3 border-t border-divider pt-5 text-sm">
              <div>
